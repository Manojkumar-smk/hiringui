		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Start UI App",
									"targetURL": "#anubhavstartmyfioriapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"anubhavstartmyfioriapp-display": {
								"semanticObject": "anubhavstartmyfioriapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=anubhav.start.myfioriapp",
									"url": sap.ui.require.toUrl("anubhav/start/myfioriapp")
								}
							}
						}
					}
