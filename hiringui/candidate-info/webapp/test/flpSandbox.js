		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comhrcandidateinfo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhrcandidateinfo-display": {
								"semanticObject": "comhrcandidateinfo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hr.candidateinfo",
									"url": sap.ui.require.toUrl("com/hr/candidateinfo")
								}
							}
						}
					}
